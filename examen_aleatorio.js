        ...
        function generar_examen() { // generamos las preguntas aleatorias
            ...
            let pasa = true;
            for (let i = 0; i<3; i++){ // empezamos a generar y guardar las posiciones de las preguntas
                ...
                if (pasa==true){
                    pos_correcta[i] = Math.floor(Math.random() *(3))+1;
        ...
        function genera_pregunta(num_pregunta, sel_pregunta) { // coloca pregunta en la posición indicada
            ...
            pregunta.innerHTML = preguntas[sel_pregunta[parseInt(num_pregunta)-1]].pregunta;
        }
        ...
        function comprobar() { // comprueba el numero de aciertos, inhabilita los radios y cambia el color a las respuetas correctas (a verde) y las incorrectas (a rojo)
            ...
            for (x = 0; x<9;x++){ // for para cambiar el color e inhabilitar los radios
                if (x<3){
                    j=parseInt(x)+1;
                } else if(x<6){
                    j=x-2;
            ...
            document.getElementById("correctas").innerHTML = "Has acertado " + aciertos + " de 3 preguntas."
